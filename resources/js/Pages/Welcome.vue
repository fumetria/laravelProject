...
<template>
    <AppLayout title="Welcome" class="">
        <template #header>
            <h1 class="font-semibold text-3xl text-gray-800 leading-tight">Welcome</h1>
        </template>
        <div>
            ...
            <div class="bg-white grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
                <div>
                ...
                <div>
                    ...
                    <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                        ...
                        for user
                        email verification and resetting forgotten passwords. So, you're free to get started with what
                        matters
